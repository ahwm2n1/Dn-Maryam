...
function sendToWhatsApp(data) {
    ...
    // WhatsApp number
    const whatsappNumber = '923209758905'; // Without + and spaces
...
function formatWhatsAppMessage(data) {
    const consultationTypeText = data.consultationType === 'in-person' ? 'In-Person' : 'Video Call (Zoom/WhatsApp)';
...
function initDatePicker() {
    ...
    hint.textContent = 'Available: Monday - Saturday';
    hint.style.cssText = `
        display: block;
        color: #999;
        font-size: 0.8rem;
